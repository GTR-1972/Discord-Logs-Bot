        ...
        try {
            ...
            for (const [_, g] of client.guilds.cache) {
                ...
                const description = [
                    ...
                    `### Default Permission : \`${command.defaultMemberPermissions ? command.defaultMemberPermissions.toString() : 'Everyone'}\``,
                    `### Options : \`\`\`\n${optionsText}\n\`\`\``,
                ...
                const embed = new EmbedBuilder()
                    .setColor('#FF0000')
                    .setAuthor({ 
                        name: `New Slash Command Created`, 
                        iconURL: g.iconURL() 
                    })
            ...
            console.error('Error handling application command creation:', error);
        }
    }
}; 